                ...
                <input type="hidden" name="token" value="{{ $token }}">
                    <div class="row">
                        ...
                        <div class="col-8 text-left">
                            <div class="mb-2"><input class="input" type="email" name="email" id="email" placeholder="abc@abc.com" value="{{ $email ?? old('email') }}"></div>
                            @if($errors->has('email'))
                        ...
                        <!-- Confirm Password -->
                        <div class="col-4 text-right">
                            <div class="mb-2"><label for="">Confirm Password<span style="color:red">*</span></label></div>
                        </div>
                        <div class="col-8 text-left">
                            <div class="mb-2"><input class="input" type="password" name="password_confirmation" id="password-confirm" placeholder="********"></div>
