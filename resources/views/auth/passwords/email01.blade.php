                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-8 text-left">
                            <div class="mb-2">
                                <input id="email" type="email" class="input" name="email" value="{{ $email ?? old('email') }}" placeholder="abc@abc.com" required>
                            </div>
                            @error('email')
                        ...
                        <div class="col-12 text-center mt-2">
                            <input class="submit-btn" type="submit" value="Send Password Reset Link">
                        </div>
                    </div>
                </form>
            </div>
