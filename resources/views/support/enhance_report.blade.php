...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('css/report.css') }}" media="screen">
...
<body>
    <div class="container-fluid">
        ...
        <div class="row header">
            ...
            <div class="col-md-8 col-xs-12 ignore-print">
        ...
        <div class="row content-section">
            ...
            <div class="col-md-10 website-details-section col-xs-12">
                ...
                <!-- @if($website_data[0]->getNotes != null)
                    <p>Client Notes: <strong>{{$website_data[0]->getNotes->client_notes}}</strong></p>
                @endif -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12" id="overall_chart_div">
            ...
            @endif
            <!-- Print Button -->
            <div class="col-12 mb-3 text-center ignore-print">
        ...
        <div class="row">
            <form action="{{route('save_notes')}}" method="post" enctype="multipart/form-data" id="notes_form">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="internal_notes" class="form-control" id="internal_notes" cols="30" rows="3">{{ $internal_notes}}</textarea>
                </div>
                <!--Client Notes-->
                <div class="mb-3">
                    <label for="client_notes"><strong>Client Notes</strong></label>
                    <textarea name="client_notes" class="form-control" id="client_notes" cols="30" rows="3">{{$client_notes}}</textarea>
                </div>
                <!--Title Notes-->
                <div class="mb-3">
                    <label for="title_notes"><strong>Title Notes</strong></label>
                    <textarea name="title_notes" class="form-control" id="title_notes" cols="30" rows="3">{{$title_notes}}</textarea>
                </div>
                <!--Description Notes-->
                <div class="mb-3">
                    <label for="description_notes"><strong>Description Notes</strong></label>
                    <textarea name="description_notes" class="form-control" id="description_notes" cols="30" rows="3">{{$description_notes}}</textarea>
                </div>
                <!--Feature Notes-->
                <div class="mb-3">
                    <label for="feature_notes"><strong>Feature Notes</strong></label>
                    <textarea name="feature_notes" class="form-control" id="feature_notes" cols="30" rows="3">{{$feature_notes}}</textarea>
                </div>
                <!--Specification Notes-->
                <div class="mb-3">
                    <label for="specification_notes"><strong>Specification Notes</strong></label>
                    <textarea name="specification_notes" class="form-control" id="specification_notes" cols="30" rows="3">{{$specification_notes}}</textarea>
                </div>
                <!--Image Notes-->
                <div class="mb-3">
                    <label for="image_notes"><strong>Image Notes</strong></label>
                    <textarea name="image_notes" class="form-control" id="image_notes" cols="30" rows="3">{{$image_notes}}</textarea>
                </div>
                <div class="mb-3">
