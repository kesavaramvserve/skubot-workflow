    ...
    <div class="container-fluid">
        ...
        <div class="row header">
            ...
            <div class="col-md-6 col-xs-12 menu-list">
              <a class="menu-item" href="{{route('pa.index')}}">PA In Progress</a>
              <a class="menu-item " href="{{route('qc_reject')}}">QC Rejected</a>
              <a class="menu-item " href="{{route('pa_complete')}}">PA Completed</a>
              <a class="menu-item active" href="{{route('pa.create')}}">Upload</a>
            </div>
            <div class="col-md-3 col-xs-12">
        ...
        <div class="row content-section">
            <div class="col-12 title">
                <div class="mt-2">
                    <span class="dot"></span>
                    <span class="website_list">Upload Enhanced File</span>
                </div>
            </div>
            <div class="col-12 table-section">
                <form action="{{route('pa.store')}}" method="post" enctype="multipart/form-data" id="import_form">
                    @csrf
                    <div class="mb-3">
