    ...
    <div class="">
        <div class="content-wrapper">
            <form action="{{route('client.result',$website_id)}}" method="get">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <span>Client Website: {{$website_name}}</span>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ asset('enhance-data/'.$website_datas[0]->getEnhancedData->path) }}" class="btn btn-primary" style="margin-left: 81%;" download>Download</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
