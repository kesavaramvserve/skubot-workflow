    ...
    <div class="">
        <div class="content-wrapper">
            <form action="{{route('client',$website_id)}}" method="get">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <span><strong>Client Website: </strong>{{$website_name}}</span>
                    </div>
                    <div class="col-md-6">
                ...
                <table  class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$title_report[0]}} SKUs <input type="hidden" name="title[]" value="{{$title_report[0]}}"><input type="checkbox" name="title1" value="{{$price_list[0]->id}}"> <br> ({{$title_pres_report[0]}}%)</td>
                            <td>{{$title_report[1]}} SKUs <input type="hidden" name="title[]" value="{{$title_report[1]}}"><input type="checkbox" name="title2" value="{{$price_list[1]->id}}"> <br> ({{$title_pres_report[1]}}%)</td>
                            <td>{{$title_report[2]}} SKUs <input type="hidden" name="title[]" value="{{$title_report[2]}}"><input type="checkbox" name="title3" value="{{$price_list[2]->id}}"> <br> ({{$title_pres_report[2]}}%)</td>
                            <td>{{$title_report[3]}} SKUs <input type="hidden" name="title[]" value="{{$title_report[3]}}"><input type="checkbox" name="title4" value="{{$price_list[3]->id}}"> <br> ({{$title_pres_report[3]}}%)</td>
                            <td>{{$title_report[4]}} SKUs <input type="hidden" name="title[]" value="{{$title_report[4]}}"><input type="checkbox" name="title5" value="{{$price_list[4]->id}}"> <br> ({{$title_pres_report[4]}}%)</td>
                        </tr>
                        <tr>
                            <td>Description Words</td>
                            <td>{{$description_report[0]}} SKUs <input type="hidden" name="description[]" value="{{$description_report[0]}}"><input type="checkbox" name="description1" value="{{$price_list[5]->id}}"> <br> ({{$description_pres_report[0]}}%)</td>
                            <td>{{$description_report[1]}} SKUs <input type="hidden" name="description[]" value="{{$description_report[1]}}"><input type="checkbox" name="description2" value="{{$price_list[6]->id}}"> <br> ({{$description_pres_report[1]}}%)</td>
                            <td>{{$description_report[2]}} SKUs <input type="hidden" name="description[]" value="{{$description_report[2]}}"><input type="checkbox" name="description3" value="{{$price_list[7]->id}}"> <br> ({{$description_pres_report[2]}}%)</td>
                            <td>{{$description_report[3]}} SKUs <input type="hidden" name="description[]" value="{{$description_report[3]}}"><input type="checkbox" name="description4" value="{{$price_list[8]->id}}"> <br> ({{$description_pres_report[3]}}%)</td>
                            <td>{{$description_report[4]}} SKUs <input type="hidden" name="description[]" value="{{$description_report[4]}}"><input type="checkbox" name="description5" value="{{$price_list[9]->id}}"> <br> ({{$description_pres_report[4]}}%)</td>
                        </tr>
                        <tr>
                            <td>Feature Bullets Count</td>
                            <td>{{$feature_report[0]}} SKUs <input type="hidden" name="feature[]" value="{{$feature_report[0]}}"><input type="checkbox" name="feature1" value="{{$price_list[10]->id}}"> <br> ({{$feature_pres_report[0]}}%)</td>
                            <td>{{$feature_report[1]}} SKUs <input type="hidden" name="feature[]" value="{{$feature_report[1]}}"><input type="checkbox" name="feature2" value="{{$price_list[11]->id}}"> <br> ({{$feature_pres_report[1]}}%)</td>
                            <td>{{$feature_report[2]}} SKUs <input type="hidden" name="feature[]" value="{{$feature_report[2]}}"><input type="checkbox" name="feature3" value="{{$price_list[12]->id}}"> <br> ({{$feature_pres_report[2]}}%)</td>
                            <td>{{$feature_report[3]}} SKUs <input type="hidden" name="feature[]" value="{{$feature_report[3]}}"><input type="checkbox" name="feature4" value="{{$price_list[13]->id}}"> <br> ({{$feature_pres_report[3]}}%)</td>
                            <td>{{$feature_report[4]}} SKUs <input type="hidden" name="feature[]" value="{{$feature_report[4]}}"><input type="checkbox" name="feature5" value="{{$price_list[14]->id}}"> <br> ({{$feature_pres_report[4]}}%)</td>
                        </tr>
                        <tr>
                            <td>Prod Specifications Count</td>
                            <td>{{$specification_report[0]}} SKUs <input type="hidden" name="specification[]" value="{{$specification_report[0]}}"><input type="checkbox" name="specification1" value="{{$price_list[15]->id}}"> <br> ({{$specification_pres_report[0]}}%)</td>
                            <td>{{$specification_report[1]}} SKUs <input type="hidden" name="specification[]" value="{{$specification_report[1]}}"><input type="checkbox" name="specification2" value="{{$price_list[16]->id}}"> <br> ({{$specification_pres_report[1]}}%)</td>
                            <td>{{$specification_report[2]}} SKUs <input type="hidden" name="specification[]" value="{{$specification_report[2]}}"><input type="checkbox" name="specification3" value="{{$price_list[17]->id}}"> <br> ({{$specification_pres_report[2]}}%)</td>
                            <td>{{$specification_report[3]}} SKUs <input type="hidden" name="specification[]" value="{{$specification_report[3]}}"><input type="checkbox" name="specification4" value="{{$price_list[18]->id}}"> <br> ({{$specification_pres_report[3]}}%)</td>
                            <td>{{$specification_report[4]}} SKUs <input type="hidden" name="specification[]" value="{{$specification_report[4]}}"><input type="checkbox" name="specification5" value="{{$price_list[19]->id}}"> <br> ({{$specification_pres_report[4]}}%)</td>
                        </tr>
                        <tr>
                            <td>Images Count</td>
                            <td>{{$image_report[0]}} SKUs <input type="hidden" name="image[]" value="{{$image_report[0]}}"><input type="checkbox" name="image1" value="{{$price_list[20]->id}}"> <br> ({{$image_pres_report[0]}}%)</td>
                            <td>{{$image_report[1]}} SKUs <input type="hidden" name="image[]" value="{{$image_report[1]}}"><input type="checkbox" name="image2" value="{{$price_list[21]->id}}"> <br> ({{$image_pres_report[1]}}%)</td>
                            <td>{{$image_report[2]}} SKUs <input type="hidden" name="image[]" value="{{$image_report[2]}}"><input type="checkbox" name="image3" value="{{$price_list[22]->id}}"> <br> ({{$image_pres_report[2]}}%)</td>
                            <td>{{$image_report[3]}} SKUs <input type="hidden" name="image[]" value="{{$image_report[3]}}"><input type="checkbox" name="image4" value="{{$price_list[23]->id}}"> <br> ({{$image_pres_report[3]}}%)</td>
                            <td>{{$image_report[4]}} SKUs <input type="hidden" name="image[]" value="{{$image_report[4]}}"><input type="checkbox" name="image5" value="{{$price_list[24]->id}}"> <br> ({{$image_pres_report[4]}}%)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
