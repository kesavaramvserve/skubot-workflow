    ...
    <div class="container-fluid">
        ...
        <div class="row content-section">
            <div class="col-12 title">
                <div class="row mt-2">
                    ...
                    <div class="col-4 text-center">
                        <a href="{{route('batches',$enc_id)}}" class="assigned_batch">Unassigned Batches</a>
                        <a href="{{route('unassign_batches',$enc_id)}}" class="unassigned_batch active">Assigned Batches</a>
                    </div>
                    <div class="col-4">
                        <a href="{{route('tl.index')}}" class="float-end back"><img src="{{asset('client/images/back.png')}}" alt="Back" title="GO Back">Back</a>
                    </div>
                </div>
            </div>
            <!-- Assign Users -->
            <div class="col-12 mt-3">
                ...
                <a href="javascript:void(0)" class="btn btn-success assign_users float-end">Re-Assign Users</a>
            </div>
            <!-- Table -->
