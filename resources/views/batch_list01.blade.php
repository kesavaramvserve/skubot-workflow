        ...
        <div class="row content-section">
            <div class="col-12 title">
                <div class="mt-2 card-header">
                    <span class="dot"></span>
                    <span class="website_list">BATCH LIST - <span style="color:yellow">{{$heading}}</span></span>
                    ...
                    @else
                        <a href="{{route('batch_list.show',$enc_id)}}" class="float-end back"><img src="{{asset('client/images/back.png')}}" alt="Back" title="GO Back">Back</a>
                    @endif
                </div>
                <!-- <div class="row mt-2">
                    <div class="col-4">
            ...
            <div class="col-3 mt-3">
                @if($user_role == 'Team Lead')
                    ...
                    @if($status == 'inqueue' || $status == 'inprogress')
                        <a href="javascript:void(0)" class="btn btn-primary assign_users">Assign Users</a>
                    @endif
                    <!-- Update Live Button -->
                    @if($status == 'completed')
                        <a href="javascript:void(0)" class="btn btn-primary update_to_live">Update to Live</a>
                    @endif
                @endif
                <!-- Export Button -->
