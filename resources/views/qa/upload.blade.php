    ...
    <div class="container-fluid">
        ...
        <div class="row header">
            ...
            <div class="col-md-5 col-xs-12 menu-list">
                ...
                <a class="menu-item " href="{{route('qa_complete')}}">QA Completed</a>
                <a class="menu-item active" href="{{route('qa.create')}}">Upload</a>
            </div>
        ...
        <div class="row content-section">
            ...
            <div class="col-12 table-section">
                <form action="{{route('qa.store')}}" method="post" enctype="multipart/form-data" id="import_form">
                    @csrf
                    <div class="mb-3">
